...
def heatmap(input_file, method, output_file="output", color="tab10"):
    ...
    clustermap.fig.suptitle("Heatmap de la méthode de production des molécules")
...
if __name__ == "__main__":
    if sys.argv[1] == "clustermap":
        heatmap(input_file=sys.argv[2], method=sys.argv[3], output_file=sys.argv[4], color=sys.argv[5])
